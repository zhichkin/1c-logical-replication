...
Процедура РегистрСведений_ПередЗаписью(Источник, Отказ, Замещение) Экспорт
	...
	// Защита от случайного включения регистра в подписки на события или состав плана обмена
	Если Источник.Метаданные() = Метаданные.РегистрыСведений.МеханизмРепликацииИсходящаяОчередь Тогда
		Возврат;
	КонецЕсли;
...
Процедура РегистрСведений_ПриЗаписи(Источник, Отказ, Замещение) Экспорт
	...
	// Защита от включения регистра в подписки на события или состав плана обмена
	Если Источник.Метаданные() = Метаданные.РегистрыСведений.МеханизмРепликацииИсходящаяОчередь Тогда
		Возврат;
	КонецЕсли;
